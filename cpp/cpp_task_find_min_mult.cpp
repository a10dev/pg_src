...
/*
 ...
 ƒана последовательность целых чисел.
 Ќеобходимо найти минимально возможное произведение пары элементов последовательности.
 Ќапример, дл€ последовательности чисел 9 4 2 5 3 ответ будет 6. „исла могут повтор€тьс€
...
// Ёти кейсы, ниже - не озвучиваютс€, соискатель доходит до них сам в ходе размышлений и беседы с интервьюверов.
// 
//
// CASE_1
